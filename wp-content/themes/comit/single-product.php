    ...
    while (have_posts()) {
        ...
        <div class="container-single-product-info">
            ...
            <div class="product-info">
                ...
                <button id="related-modal-button" class="button-type-3">Book this product <svg class="arrow-svg" width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
